...
class GameUI:
    ...
    def __init__(self, width=600, height=600):
        ...
        self.window.tracer(0)  # Wyłączenie automatycznego rysowania dla płynności animacji
        ...
        # Obiekty gry z użyciem bezbłędnych kształtów standardowych (Zamyka kryterium stabilności)
        self.player_render = turtle.Turtle()
        self.player_render.speed(0)
        self.player_render.shape("triangle")  # Biały trójkąt jako statek gracza
        self.player_render.color("white")
        self.player_render.penup()

        self.enemy_render = turtle.Turtle()
        self.enemy_render.speed(0)
        self.enemy_render.shape("circle")     # Czerwone koło jako wróg
        self.enemy_render.color("red")
        self.enemy_render.penup()

        # Laser (Żółty pocisk)
        self.laser_render = turtle.Turtle()
        self.laser_render.speed(0)
    ...
    def render(self, engine):
        ...
        if engine.state == "MENU":
            ...
            # Ukrywanie obiektów po przegranej
            self.player_render.goto(1000, 1000)
            self.enemy_render.goto(1000, 1000)
            self.laser_render.goto(1000, 1000)
        ...
        self.window.update()  # Ręczne wymuszenie odświeżenia klatki (Wydajność)
